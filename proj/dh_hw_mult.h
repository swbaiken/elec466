...
SC_MODULE (dh_hw_mult) {
	...
	SC_CTOR (dh_hw_mult) : 
		clk("clk"), hw_mult_enable("hw_mult_enable"), in_data_1("in_data_1"), in_data_2("in_data_2"),
		out_data_high("out_data_high"), hw_mult_done("hw_mult_done"),out_data_low("out_data_low"),
		ult_a0("mult_a0"), mult_a1("mult_a1"), mult_u("mult_u"), mult_t("mult_t"), 
